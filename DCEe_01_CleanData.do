...
////////////////////////////////////////////////////////////////////////////////
**# Organizar la base de datos de cada país
////////////////////////////////////////////////////////////////////////////////
...
* Opción 1: elegir un país específico
*glo pais="chile"
*glo pais="colombia"
*glo pais="argentina"

* Opcion 2: correr los tres países
foreach pais in "chile" "colombia" "argentina" {
	glo pais="`pais'"
	*
	...
	* Do not save in the excel, we need the numberic version
...
summarize all_time if cat_time>=-1 , detail // 90secs or more
